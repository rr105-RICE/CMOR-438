...
- `.github/CODEOWNERS` assigns default reviewer `@rr105` for every path.
...
- `docs/screenshots/` stores images referenced in documentation.
...
- Name: Ricardo Rivera
- NetID: rr105
- Email: rr105@rice.edu

## Screenshots

Add screenshots under `docs/screenshots/` and reference them here using Markdown:

```
![Description](docs/screenshots/your-image.png)
```

> Tip: Keep filenames lowercase and hyphenated (e.g., `workflow-overview.png`) so they render cleanly on GitHub.
